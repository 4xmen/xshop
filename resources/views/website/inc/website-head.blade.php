<!doctype html>
<html lang="{{app()->getLocale()}}" @if(langIsRTL(app()->getLocale())) dir="rtl" @else dir="ltr"
      @endif @if(gfx()['dark'] == 1) data-bs-theme="dark" @endif >
<head>
    <meta charset="UTF-8">
    <meta name="viewport"
    ...
    @else
        ...
        <link rel="alternate" type="application/rss+xml" title="{{__("Product RSS Feed")}}"
