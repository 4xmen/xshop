...
@section('filter')
    ...
    <div class=" mt-2">
        <div class="form-group">
            ...
            <vue-datetime-picker-input
                xid="start_date"   xname="start_date" xtitle="{{__("Start date")}}"  :timepicker="true" @if(app()->getLocale() != 'fa')  def-tab="1" xshow="datetime"  @else xshow="pdatetime"  @endif
    ...
    <div class="mt-2 mb-2">
        <div class="form-group">
            ...
            <vue-datetime-picker-input
                xid="end_date" xname="end_date" xtitle="{{__("End date")}}"  :timepicker="true" @if(app()->getLocale() != 'fa')  def-tab="1" xshow="datetime"  @else xshow="pdatetime"  @endif
