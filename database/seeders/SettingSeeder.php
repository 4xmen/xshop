    ...
    public function run(): void
    {
        ...
        $sections = [
            ...
            'SEO' => [
                ...
                [
                    'title' => __('Other language add to sitemap (just available items & just for multilanguage sites)'),
                    'key' => 'sitemap_multi_lang',
                    'type' => 'CHECKBOX',
                    'value' => 1,
                    'size' => 12,
                ],
                [
                    'title' => __('Category site map'),
                ...
                [
                    'title' => __('Attachment site map'),
                    'key' => 'sitemap_attachment',
                    'type' => 'CHECKBOX',
                    'value' => 1,
                    'size' => 4,
                ],
                [
                    'title' => __('Posts site map'),
                    'key' => 'sitemap_post',
                    'type' => 'CHECKBOX',
                    'value' => 1,
                    'size' => 6,
